...
SECTIONS = {
    "mixer":     "https://elllo.org/mixer",                                    # multi-speakers B2/C1 (récent)
    "mixer001":  "https://elllo.org/english/Mixer001/",                        # mixer 001-025
    "mixer026":  "https://elllo.org/english/Mixer026/",                        # mixer 026-050
    "mixer051":  "https://elllo.org/english/Mixer051/",                        # mixer 051-075
    "mixer076":  "https://elllo.org/english/Mixer076/",                        # mixer 076-100
    "mixer101":  "https://elllo.org/english/Mixer101/",                        # mixer 101-125
    "views_b2":  "https://elllo.org/levels/views/B2-views.html",              # vues B2
    "views_c1":  "https://elllo.org/levels/views/C1-views.html",              # vues C1
    "level_b2":  "https://elllo.org/levels/B2-English-Lessons/B2-OME-01-25.html", # leçons B2
    "views_c1b": "https://elllo.org/levels/C1-English-Lessons/C1-VIEWS-01-25.html", # vues C1 supplémentaires
}
...
def extract_lesson_links(index_url: str) -> list[str]:
    ...
    for a in soup.find_all("a", href=True):
        ...
        if re.search(r"[A-Z]\d+[-\w]*\.htm$", href) or re.search(r"\d+[-\w]+\.htm$", href):
